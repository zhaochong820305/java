    ...
    static String keysqll="";
	 public static void main(String[] args) {
		 ...
		 try{
			 ...
			 String str = "";			
			 String sql1 = "select * from diagnosecase where  record_state=2 limit 0,1000 ";
			 ResultSet rs = statement.executeQuery(sql1); 
			 	
			 String ssql1=" INSERT INTO indexrootcausenew (`item_id`,`case_id`) VALUES";
			 String ssql2=" INSERT INTO indexsymptomnew (`item_id`,`case_id`) VALUES";
			 String ssql3=" INSERT INTO indexdiseasenew (`item_id`,`case_id`) VALUES";
			 String ssql4=" INSERT INTO indextcmsymptomnew (`item_id`,`case_id`) VALUES";
			 String ssql5=" INSERT INTO indextherapynew (`item_id`,`case_id`) VALUES";
			 String ssql6=" INSERT INTO indexmedicinenew (`item_id`,`case_id`) VALUES";
			 String ssql7=" INSERT INTO indexacupointnew (`item_id`,`case_id`) VALUES";
